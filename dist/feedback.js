...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Feedback"] = __webpack_require__(/*! -!./node_modules/ts-loader??ref--4-1!./index.ts */ "./node_modules/ts-loader/index.js?!./index.ts");
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["Feedback"] = __webpack_require__(/*! -!./node_modules/ts-loader??ref--4-1!./feedback.ts */ "./node_modules/ts-loader/index.js?!./lib/feedback.ts");
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../node_modules/webpack/buildin/global.js */ "./node_modules/webpack/buildin/global.js")))
...
/***/ "./node_modules/ts-loader/index.js?!./index.ts":
/*!*****************************************************!*\
  !*** ./node_modules/ts-loader??ref--4-1!./index.ts ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var feedback_1 = __webpack_require__(/*! ./lib/feedback */ "./lib/feedback.ts-exposed");
exports.Feedback = feedback_1.Feedback;


/***/ }),

/***/ "./node_modules/ts-loader/index.js?!./lib/feedback.ts":
/*!************************************************************!*\
  !*** ./node_modules/ts-loader??ref--4-1!./lib/feedback.ts ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var html2canvas = __webpack_require__(/*! html2canvas */ "./node_modules/html2canvas/dist/npm/index.js");
var Feedback = /** @class */ (function () {
    function Feedback(options, html2canvasOptions) {
        var _this = this;
        this.close = function () {
            ...
            document.removeEventListener('keydown', _this._closeListener);
            document.removeEventListener('mousemove', _this._highlightElement);
            ...
            document.body.removeChild(_this._root);
            _this._reset();
        };
        this._options = {
            classPrefix: 'fb-',
        ...
        this._closeListener = function ($event) {
            if ($event.key === 'Escape') {
                _this.close();
            }
        };
        this._toggleScreenshot = function ($event) {
            $event.preventDefault();
            _this._state.includeScreenshot = !_this._state.includeScreenshot;
            _this._checkbox.checked = _this._state.includeScreenshot;
            _this._checkboxSvg.setAttributeNS(null, 'fill', _this._state.includeScreenshot ? _this._checkedColor : _this._uncheckedColor);
            _this._checkboxSvgPath.setAttributeNS(null, 'd', _this._state.includeScreenshot ? _this._checkedPath : _this._uncheckedPath);
            if (!_this._state.includeScreenshot) {
                _this._form.removeChild(_this._screenshotContainer);
            }
            else {
                _this._form.insertBefore(_this._createScreenshotContainer(), _this._footnoteContainer);
                _this._genScreenshot();
            }
        };
        this._openDrawer = function () {
            _this._state.canDraw = true;
            _this._canvas.classList.add('active');
            _this._formContainer.style.display = 'none';
            _this._root.appendChild(_this._createDrawOptions());
            document.addEventListener('mousemove', _this._highlightElement);
            document.addEventListener('click', _this._addHighlightedElement);
        };
        this._closeDrawer = function () {
            _this._state.canDraw = false;
            _this._canvas.classList.remove('active');
        ...
        this._dragStart = function ($event) {
            if (!_this._state.isDragging) {
                _this._state.isDragging = true;
                _this._drawOptionsPos.startX = $event.clientX;
                _this._drawOptionsPos.startY = $event.clientY;
                var rect = _this._drawOptions.getBoundingClientRect();
                _this._drawOptionsPos.limits.xNeg = -rect.left;
                _this._drawOptionsPos.limits.xPos = document.documentElement.clientWidth - rect.right;
                _this._drawOptionsPos.limits.yNeg = -rect.top;
                _this._drawOptionsPos.limits.yPos = document.documentElement.clientHeight - rect.bottom;
            }
        };
        ...
        this._highlightElement = function ($event) {
            _this._highlightedArea = null;
            // We need the 3rd element in the list.
            if (!_this._state.canDraw || _this._state.isDrawing) {
                return;
            }
            var el = document.elementsFromPoint($event.x, $event.y)[3];
            if (el) {
                if (_this._options.allowedTags.indexOf(el.nodeName.toLowerCase()) === -1) {
                    _this._redraw();
                    _this._canvas.style.cursor = 'crosshair';
                    return;
                }
                _this._canvas.style.cursor = 'pointer';
                var rect = el.getBoundingClientRect();
                _this._highlightedArea = {
                ...
                _this._redraw();
                if (_this._state.highlight) {
                    _this._drawLines(_this._highlightedArea.startX, _this._highlightedArea.startY, _this._highlightedArea.width, _this._highlightedArea.height);
                    _this._ctx.clearRect(_this._highlightedArea.startX, _this._highlightedArea.startY, _this._highlightedArea.width, _this._highlightedArea.height);
                }
                _this._paintArea();
                if (!_this._state.highlight) {
                    _this._ctx.fillStyle = 'rgba(0,0,0,.5)';
                    _this._ctx.fillRect(_this._highlightedArea.startX, _this._highlightedArea.startY, _this._highlightedArea.width, _this._highlightedArea.height);
                }
                _this._paintArea(false);
            }
        };
        ...
        this._onScroll = function () {
            ...
            _this._canvas.style.left = x + "px";
            _this._canvas.style.top = y + "px";
            _this._helpersContainer.style.left = x + "px";
            _this._helpersContainer.style.top = y + "px";
        };
        if (options) {
            this._options = __assign({}, this._options, options);
        }
        if (html2canvasOptions) {
            this._html2canvasOptions = __assign({}, this._html2canvasOptions, html2canvasOptions);
        }
    }
    ...
    Feedback.prototype._createSelectLabel = function () {
        var label = document.createElement('label');
        label.innerText = this._options.dropdownLabel;
        label.className = 'selectlabel';
        return label;
    };
    Feedback.prototype._createSelectBox = function () {
        ...
        fetch(this._options.dropdownEndpoint, { headers: this.getHeaders() })
            ...
            if (response.result) {
                response.result.forEach(function (option) {
    ...
    Feedback.prototype.getHeaders = function () {
        var headers = new Headers();
        headers.append('Content-Type', 'application/json');
        if (this._options.headers) {
            this._options.headers.forEach(function (value, key) {
                headers.append(key, value);
            });
        }
        return headers;
    };
    Feedback.prototype._send = function () {
        var _this = this;
        this._state.sending = true;
        this._showSending();
        var select = document.getElementById('feedbackType');
        var lookupValueId = select.options[select.selectedIndex].value;
        var data = {
        ...
        fetch(this._options.endpoint, {
            ...
            .then(function (resp) {
            if (resp.ok) {
                _this._state.sending = false;
                _this._showSent();
            }
            else {
                throw new Error("failed to post data to " + _this._options.endpoint);
            }
        })
            .catch(function (_) {
            _this._state.sending = false;
    ...
    Feedback.prototype._genScreenshot = function () {
        var _this = this;
        this._html2canvasOptions = __assign({}, this._html2canvasOptions, { width: window.innerWidth, height: window.innerHeight, scrollX: window.pageXOffset, scrollY: window.pageYOffset, x: window.pageXOffset, y: window.pageYOffset });
        while (this._screenshotContainer.firstChild) {
            this._screenshotContainer.removeChild(this._screenshotContainer.firstChild);
        }
        this._redraw(false);
        html2canvas(document.body, this._html2canvasOptions).then(function (canvas) {
            _this._screenshotCanvas = canvas;
            _this._screenshotContainer.appendChild(canvas);
            _this._redraw();
        });
    };
    Feedback.prototype._createHeader = function () {
    ...
    Feedback.prototype._createForm = function () {
        ...
        form.appendChild(this._createSelectLabel());
        form.appendChild(this._createSelectBox());
    ...
    Feedback.prototype._createTextarea = function () {
        var textarea = document.createElement('textarea');
        textarea.placeholder = 'Describe your issue or share your ideas.';
        return textarea;
    };
    Feedback.prototype._createCheckboxContainer = function () {
        ...
        var checkboxSvgContainer = document.createElement('div');
        ...
        var checkboxLabelSpan = document.createElement('span');
        checkboxLabelSpan.innerText = 'Include screenshot';
        checkboxLabel.appendChild(checkboxLabelSpan);
        checkboxContainer.appendChild(checkboxLabel);
        return checkboxContainer;
    };
    Feedback.prototype._createScreenshotContainer = function () {
    ...
    Feedback.prototype._createDrawOptions = function () {
        var _this = this;
        var drawOptions = document.createElement('div');
        drawOptions.className = this._options.classPrefix + "draw-options";
        var draggerContainer = document.createElement('div');
        ...
        var highlightButtonContainer = document.createElement('div');
        ...
        highlightButton.addEventListener('click', function () { return _this._state.highlight = true; });
        highlightButtonContainer.appendChild(highlightButton);
        drawOptions.appendChild(highlightButtonContainer);
        var blackoutButtonContainer = document.createElement('div');
        var blackoutButton = document.createElement('button');
        ...
        blackoutButton.addEventListener('click', function () { return _this._state.highlight = false; });
    ...
    Feedback.prototype._showSending = function () {
        var container = document.createElement('div');
    ...
    Feedback.prototype._showSent = function () {
    ...
    Feedback.prototype._showError = function () {
        var _this = this;
        this._formContainer.removeChild(this._sendingContainer);
        var container = document.createElement('div');
        container.className = 'status';
        ...
        backButton.addEventListener('click', function () {
            _this._form.style.display = 'flex';
            _this._formContainer.removeChild(_this._errorContainer);
        });
...
/***/ 0:
/*!********************************************!*\
  !*** multi ./index.ts ./lib/feedback.scss ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
